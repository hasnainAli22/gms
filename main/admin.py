...
class BannnerAdmin(admin.ModelAdmin):
    list_display = ('alt_text', 'image_tag')
admin.site.register(models.Banners, BannnerAdmin)
...
class EquipmentInventoryAdmin(admin.ModelAdmin):
    list_display=('name', 'description', 'maintenance_status', 'image_tag')
admin.site.register(models.EquipmentInventory, EquipmentInventoryAdmin)
